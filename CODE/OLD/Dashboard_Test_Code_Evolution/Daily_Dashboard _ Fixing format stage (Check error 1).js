...
function updateDailyDashboardTest() {
  ...
  try {
    ...
    // This clears from the end of the rep table to where the low ratings section starts
    sheet.getRange(`B${RepTableEndRow+1}:O${lowDataStartRow+10}`).clearContent();
    sheet.getRange(`B${RepTableEndRow+1}:O${lowDataStartRow+10}`).breakApart();
